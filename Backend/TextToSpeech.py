import pygame     # Importing the pygame library to handle audio playback
import random    # Importing random to select random files
import asyncio   # Importing asyncio for asynchronous operations
import edge_tts  # Importing edge_tts for text-to-speech conversion
...
# Function to manage Text-to-Speech with additional response for long texts
